  ...
  return (
    <>
      ...
      <div className="p-4">
        ...
        {danceClass.competitionEntryNumber && (
          <p className="text-amber-700">Competitive</p>
        )}
        {danceClass.competitionEntryNumber && (
          <div>
            <p>{danceClass.competitionName}</p>
            <p>Entry Number {danceClass.competitionEntryNumber}</p>
            <p>{`${danceClass.competitionEntryDayOfWeek}, ${danceClass.competitionEntryTime}`}</p>
          </div>
        )}
      </div>
    </>
