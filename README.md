...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create dn2024blues-02e3
  fly apps create dn2024blues-02e3-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app dn2024blues-02e3
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app dn2024blues-02e3-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'dn2024blues-02e3-staging' does not match app name in config file 'dn2024blues-02e3'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name dn2024blues-02e3-db
  fly postgres attach --app dn2024blues-02e3 dn2024blues-02e3-db

  fly postgres create --name dn2024blues-02e3-staging-db
  fly postgres attach --app dn2024blues-02e3-staging dn2024blues-02e3-staging-db
  ```
